...
XML-RPC interface. Look at the [documentation]([link for API documentation](https://github.com/uiuc-iml/IML-Perception-Box/wiki/Mapping-Module-API-Documentation) for more information. See example_client.py for inspiration.
